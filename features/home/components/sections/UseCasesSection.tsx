        ...
        >
          ...
          <div className='feature-block relative z-10 flex flex-col lg:flex-row items-center gap-12 lg:gap-16'>
            ...
            >
              ...
              <div className='surface hover-lift pattern-card relative p-6 sm:p-7'>
                ...
                <div className='rounded-2xl bg-[#f8faf4] border border-[#ecefe7] p-5'>
                  ...
                  <div className='h-2.5 rounded-full bg-[#eef2e6] overflow-hidden'>
                    <div
                      className='crawl-bar h-full bg-primary rounded-full'
                      style={{ width: '76%' }}
                    ></div>
                  </div>
                  <div className='mt-2 text-xs font-bold text-[#9aa49a]'>
                    يفحص الآن: /products/category/shoes
                  </div>
                </div>
                <div className='mt-4 grid grid-cols-3 gap-3'>
                  <div className='rounded-2xl bg-white border border-[#ecefe7] p-4 text-center'>
                    ...
                    <div className='text-[10px] font-bold text-[#9aa49a] mt-1'>
                      صفحات تم فحصها
                    </div>
                  </div>
                  <div className='rounded-2xl bg-white border border-[#ecefe7] p-4 text-center'>
                    <div
                      className='text-2xl font-extrabold text-[#b8851c]'
                      data-counter
                      data-target='37'
                    >
                      0
                  ...
                  <div className='rounded-2xl bg-primary/12 border border-primary/30 p-4 text-center'>
                    ...
                    <div className='text-[10px] font-bold text-[#5c7a20] mt-1'>
                      صحة SEO
                    </div>
                  </div>
                </div>
              ...
              <div
                className='floaty absolute -top-6 -right-3 sm:-right-7 p-3.5 rounded-2xl bg-white/70 backdrop-blur-md border border-white/60 shadow-[0_24px_48px_-22px_rgba(19,26,20,0.22)] hidden sm:block'
                data-float='a'
              >
                <div className='flex items-center gap-2.5'>
                  ...
                  <div>
                    <div className='text-[10px] font-bold text-[#9aa49a]'>
                      سرعة الفحص
                    </div>
            ...
            >
              ...
              <div className='surface hover-lift pattern-card relative p-6 sm:p-7'>
                ...
                <div className='rounded-2xl bg-[#f8faf4] border border-[#ecefe7] p-4'>
                  <div className='text-[11px] font-extrabold text-[#9aa49a] mb-2'>
                    عنوان Meta
                  </div>
                  <div className='flex items-start gap-2 mb-2'>
                    <span className='text-[10px] font-bold text-[#c0392b] bg-[#fdecea] px-2 py-0.5 rounded-md mt-0.5 shrink-0'>
                      قبل
                    </span>
                    <span className='text-[13px] text-[#9aa49a] line-through'>
                      الصفحة الرئيسية
                    </span>
                  </div>
                  <div className='flex items-start gap-2'>
                    <span className='text-[10px] font-bold text-primary-700 bg-primary/15 px-2 py-0.5 rounded-md mt-0.5 shrink-0'>
                      بعد
                    </span>
                    <span className='text-[13px] font-semibold text-ink'>
                      متجر هويّة — أحذية رياضية أصلية بأفضل الأسعار | شحن
                      سريع
                    </span>
                  </div>
                </div>
                <div className='mt-3 rounded-2xl bg-[#f8faf4] border border-[#ecefe7] p-4'>
                  ...
                  <div className='flex items-start gap-2'>
                    ...
                    <span className='text-[13px] font-semibold text-ink'>
                      تسوّق أحدث الأحذية الرياضية الأصلية مع توصيل سريع
                      وضمان الجودة من متجر هويّة.
                    </span>
                  </div>
                </div>
                <div className='mt-3 flex items-center gap-2 rounded-xl bg-white border border-[#ecefe7] px-4 py-3'>
                  ...
                  <span className='text-[13px] font-semibold text-[#4a5a4c]'>
                    مخطط منظَّم (Schema) — Product
                  </span>
                  <span className='mr-auto text-[10px] font-bold text-primary-700 bg-primary/15 px-2 py-1 rounded-full'>
                    جاهز
                  </span>
                </div>
              </div>
              <div
                className='floaty absolute -bottom-6 -left-3 sm:-left-8 p-3.5 rounded-2xl bg-white/70 backdrop-blur-md border border-white/60 shadow-[0_24px_48px_-22px_rgba(19,26,20,0.22)] hidden sm:block'
                data-float='b'
              >
                <div className='flex items-center gap-2.5'>
                  <span className='w-9 h-9 rounded-xl bg-primary/15 flex items-center justify-center'>
            ...
            >
              ...
              <div className='surface hover-lift pattern-card relative p-6 sm:p-7'>
                <div className='flex items-center justify-between mb-5'>
                  ...
                  <span className='text-xs font-bold text-[#b8851c] bg-[#fff6e6] px-3 py-1.5 rounded-full'>
                    بانتظار موافقتك
                  </span>
                </div>
                <div className='rounded-2xl bg-[#f8faf4] border border-[#ecefe7] p-4'>
                  <div className='text-[11px] font-extrabold text-[#9aa49a] mb-3'>
                    تغيير مقترح على عنوان الصفحة
                  </div>
                  <div className='rounded-xl bg-[#fdecea] border border-[#f5c6c0] px-3 py-2.5 mb-2'>
                    <span className='text-[13px] text-[#a93226] line-through'>
                      منتجاتنا
                    </span>
                  </div>
                  ...
                  <div className='rounded-xl bg-primary/12 border border-primary/30 px-3 py-2.5'>
                    <span className='text-[13px] font-semibold text-[#2f4012]'>
                      تشكيلة الأحذية الرياضية 2026 | متجر هويّة
                    </span>
                  </div>
                </div>
                <div className='mt-4 flex items-center gap-2.5'>
                  ...
                  <button className='inline-flex items-center justify-center gap-2 bg-white border border-[#ecefe7] text-[#4a5a4c] font-bold py-3 px-4 rounded-full'>
                    تعديل
                  </button>
                  <button
                    className='inline-flex items-center justify-center w-11 h-11 bg-white border border-[#ecefe7] text-[#c0392b] rounded-full'
                    aria-label='رفض'
                  >
                    <svg
                      width='18'
              ...
              <div
                className='floaty absolute -top-6 -left-3 sm:-left-8 p-3.5 rounded-2xl bg-white/70 backdrop-blur-md border border-white/60 shadow-[0_24px_48px_-22px_rgba(19,26,20,0.22)] hidden sm:block'
                data-float='c'
              >
                <div className='flex items-center gap-2.5'>
                  <span className='w-9 h-9 rounded-xl bg-primary/15 flex items-center justify-center'>
            ...
            >
              ...
              <div className='surface hover-lift pattern-card relative p-6 sm:p-7'>
                <div className='flex items-center justify-between mb-5'>
                  ...
                  <span className='text-xs font-bold text-primary-700 bg-primary/15 px-3 py-1.5 rounded-full'>
                    +63% أداء
                  </span>
                </div>
                <div className='rounded-2xl bg-[#f8faf4] border border-[#ecefe7] p-5'>
                  ...
                  >
                    ...
                    <path
                      d='M0,88 L53,74 L106,80 L160,52 L213,44 L266,26 L320,16 L320,110 L0,110 Z'
                      fill='url(#trendFill)'
                    />
                    <path
                      className='trend-line'
                      d='M0,88 L53,74 L106,80 L160,52 L213,44 L266,26 L320,16'
                      fill='none'
                      stroke='#a0cd39'
                      strokeWidth='3'
                      strokeLinecap='round'
                ...
                <div className='mt-4 grid grid-cols-2 gap-3'>
                  <div className='flex items-center gap-3 rounded-xl bg-white border border-[#ecefe7] px-4 py-3'>
                    <span className='w-9 h-9 rounded-xl bg-[#fdecea] flex items-center justify-center text-[#c0392b] font-extrabold text-xs'>
                      404
                    </span>
                    <div>
                      <div
              ...
              <div
                className='floaty absolute -bottom-6 -right-3 sm:-right-8 p-3.5 rounded-2xl bg-white/70 backdrop-blur-md border border-white/60 shadow-[0_24px_48px_-22px_rgba(19,26,20,0.22)] hidden sm:block w-[220px]'
                data-float='d'
              >
                <div className='flex items-start gap-2.5'>
                  ...
                  <div>
                    ...
                    <div className='text-[13px] font-extrabold text-ink leading-snug'>
                      رُصدت صفحة 404 جديدة — تحقّق منها
                    </div>
                  </div>
                </div>
              </div>
